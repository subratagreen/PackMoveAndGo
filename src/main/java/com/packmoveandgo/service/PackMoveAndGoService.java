...
public interface PackMoveAndGoService {
	...
	int addMaterialUsed(MaterialUsed  materialUsed);
	int addPackingMaterials(PackingMaterials materials);
	...
	com.packmoveandgo.model.CustomerRegister getCustomerDetailById(int cust_id);
