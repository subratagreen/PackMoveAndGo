...
<%if(session.getAttribute("userType") == null){%>
	...
	<form action="proofOfDelivery" method="post" id="contactFrm"
		enctype="multipart/form-data" name="contactFrm">
		<div class="container mrtopbtm">
			<div class="row">
				<div class="col-sm-4 col-md-offset-4">
					<h3 class="colorcoffee">Proof Of Delivery</h3>
					<hr />
				...
				<div class="col-md-4 col-md-offset-4">
					...
					<div class="form-group">
						<label for="proofOfDeliveryFile"> Select Proof of Delivery
							file :</label>
						<div class="input-group">
							<span class="input-group-addon"><span
								class="glyphicon glyphicon-file"></span></span> <input type="file"
								name="proofOfDeliveryFile" class="form-control"
								id="proofOfDeliveryFile"
								placeholder="Select Proof Of Delivery File " 
								required="required" />
						</div>
					...
					<!-- <div class="form-group">
						...
						<div class="input-group">
							<span class="input-group-addon"><span
								class="glyphicon glyphicon-file"></span></span> <input type="text"
								name="name" class="form-control"
								id="name"
								placeholder="Selected Proof Of Delivery File Name " 
								 />
						</div>
					</div> -->
		...
		<input type="submit" value="Upload"> Press here to upload the file!
					...
					<div class="col-md-12 text-center mrbtm">
						<input type="submit" name="submit" id="button" value="Upload File"
