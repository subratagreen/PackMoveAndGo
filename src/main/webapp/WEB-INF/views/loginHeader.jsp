...
<body>
	...
	<div class="container whitebg">
		...
		<%-- <div
				...
				data-wow-delay="0.4s">
				<img
					src="${pageContext.request.contextPath}/images/callus.jpg"
			...
			<div class="row">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<li><a href="${pageContext.request.contextPath}/trackOrder">Track Order</a></li>
						<%-- <li><a href="${pageContext.request.contextPath}/advanceSearch">Advance Search</a></li> --%>
						<li><a href="${pageContext.request.contextPath}/sendEnquiry">Enquiry</a></li>
						<%-- <li><a href="${pageContext.request.contextPath}/fastBooking">Booking</a></li> --%>
						<li><a href="${pageContext.request.contextPath}/services">Services</a></li>
						<%-- <li><a href="${pageContext.request.contextPath}/consignmentStatus">Consignment Status</a></li>--%>
						<li><a href="${pageContext.request.contextPath}/clients">Clients</a></li>
						<li><a href="${pageContext.request.contextPath}/process">Process</a></li>
					...
					<ul class="nav navbar-nav navbar-right">
						<li><a href="${pageContext.request.contextPath}/login"
							><span class=" glyphicon glyphicon-log-in"
								aria-hidden="true"></span> Login<span class="sr-only">(current)</span></a></li>
					</ul>
				</div>
				<!--/.nav-collapse -->
			</div>
