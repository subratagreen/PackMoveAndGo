...
.at4-follow-inner {
	...
	<br>
	<br>
	<form:form action="addItem" method="post" id="contactFrm"
		modelAttribute="addItem" name="contactFrm">
				...
				<table class="table table-bordered" id="dataTable"
					...
					<c:forEach items="${orderDetailsList}" var="details">
                  	...
                  	<c:param name="order_id" value="${details.order_id}"/>
							...
							<td><a
								href="
                  	<c:url value='advanceSearchViewOrder'>
                  	<c:param name="order_id" value="${details.order_id}"/>
					</c:url>">View
									Order/Update Consignment Status</a>/</td>
						</tr>
					</c:forEach>
