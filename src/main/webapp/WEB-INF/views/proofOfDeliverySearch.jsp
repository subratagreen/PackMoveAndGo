...
<%if(session.getAttribute("userType") == null){%>
	...
	<form:form action="proofOfDeliverySearch" method="post" id="contactFrm"
	 modelAttribute="proofOfDeliverySearch"
		name="contactFrm">
		<div class="container mrtopbtm">
			<div class="row">
				<div class="col-sm-4 col-md-offset-4">
					<h3 class="colorcoffee">Proof Of Delivery Search</h3>
					<hr />
				...
				<div class="col-md-4 col-md-offset-4">
					...
					<div class="form-group">
						<label class="text-danger">Note :Enter Either Order Number or Booking Number</label>
					</div>
					<div class="form-group">
