...
<meta name="viewport" content="width=device-width,initial-scale=1">
 <meta name="description" content="Insurance is another essential factor in our service, as Packers and Movers in Delhi NCR (Packers and Movers System) has to transport your goods to the desired destination; the safety of the goods is also our responsibility. The insurance documentation is also responsibility of Movers and Packers in Delhi NCR ( Movers and Packers). " />
    <meta name="keywords" content="Insurance Services Ved vihar | Packing and Moving Services in Secunderabad " />
			...
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 pull-right maintxt">
				...
				<div class="col-md-12  wow fadeInDown" data-wow-delay="0.4s">
					<div class="row">
						...
						<h3 class="colorred">Insurance Services</h3>
						<div class="col-md-6 col-sm-6 col-xs-12 pull-right mrbtm2">
							<img src="${pageContext.request.contextPath}/resources/images/insurance-services.jpg" width="450" height="300"
								alt="Insurance Services"
								class="img-responsive img-rounded img-thumbnail"
								data-toggle="tooltip" data-placement="left"
								title="Insurance Services" />
						</div>
						<p>Insurance is another essential factor in our service, as
							Packers and Movers in Delhi NCR (Packers and Movers System) has
							to transport your goods to the desired destination; the safety of
							the goods is also our responsibility. The insurance documentation
							is also responsibility of Movers and Packers in Delhi NCR
							( Movers and Packers). The insurance documentation is
							necessary as a precautionary measure towards the goods in
							transit. The insurance documentations procedures will be taken
							care of by the  Movers and Packers - Delhi NCR.</p>
			...
			<div class="col-md-12">
				<div id="Carousel" class="carousel slide">
					...
					<a data-slide="next" href="#Carousel"
						class="right carousel-control">âº</a>
				</div>
				<!--.Carousel-->
