			...
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 pull-right maintxt">
				...
				<div class="col-md-12  wow fadeInDown" data-wow-delay="0.4s">
					<div class="row">
						...
						<h3 class="colorred">Car Carrier Services</h3>
						<div class="col-md-6 col-sm-6 col-xs-12 pull-right mrbtm2">
							<img src="${pageContext.request.contextPath}/resources/images/car-carrier-services.jpg" width="450"
								height="300" alt="Car Carrier Services"
								class="img-responsive img-rounded img-thumbnail"
								data-toggle="tooltip" data-placement="left"
								title="Car Carrier Services" />
						</div>
						<p>
							We, at Packers and Movers System - Delhi NCR offer Car
							Transportation Services in all over India. Movers and Packers in
							Delhi NCR ( Movers) offers worthwhile Car Transportation
							Services and make sure that our clients or customers for a quick,
							smooth, and prompt deliveries of your most prized cars. While
							transporting your cars we take a lot &amp; utmost care of your
							cars and make them safe for even a minor scratch. Packers and
							Movers in Delhi NCR (Packers and Movers System) has gained a
							reputation to provide&nbsp;quality relocation services including,
							packing, unpacking, loading, unloading, and off course Car
							Transportation. Movers and Packers in Delhi NCR ( Movers
							and Packers) handle transporting of all types of cars<strong>.</strong>
						</p>
						<a class="btn btn-default"
							href="${pageContext.request.contextPath}/services" role="button">[+]
							More Services</a>
						<hr />
					</div>
				</div>
