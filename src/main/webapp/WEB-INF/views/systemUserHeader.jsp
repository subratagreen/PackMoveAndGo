			...
			<div class="row">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li><a href="${pageContext.request.contextPath}/fastBooking">Fast Booking</a></li>
						<li><a href="${pageContext.request.contextPath}/consignmentStatus">Track Order</a></li>
						<li><a href="${pageContext.request.contextPath}/proofOfDeliverySearch">Proof of delivery</a></li> 
						<%-- <li><a href="${pageContext.request.contextPath}/downloadPDF">DownloadPDF</a></li> --%>
						...
						<li><a href="${pageContext.request.contextPath}/enquiryDetails">Enquiry Details</a></li>
