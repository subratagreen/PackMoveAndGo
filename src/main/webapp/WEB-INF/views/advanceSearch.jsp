...
.at4-follow-inner {
	...
	<form:form action="advanceSearch" method="post" id="contactFrm"
		modelAttribute="advanceSearch" name="contactFrm">
		<div class="container mrtopbtm">
			<div class="row">
				<div class="col-sm-4 col-md-offset-4">
					<h3 class="colorcoffee">Advance Search</h3>
					<hr />
				...
				<div class="col-md-4 col-md-offset-4">
					...
					<div class="form-group">
						<label class="text-danger">Note :Enter Only One Input
							Entry</label>
					</div>
					<div class="form-group">
						...
						<div class="input-group">
							<span class="input-group-addon"><span
								...
								type="number" name="orderId" class="form-control" id="orderId"
					...
					<div class="form-group">
						...
						<div class="input-group">
							<span class="input-group-addon"><span
								class="glyphicon glyphicon-envelope"></span></span> <input
								type="number" name="bookingId" class="form-control"
								id="bookingId" placeholder="Enter Booking Number " />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="input-group">
							<span class="input-group-addon"><span
								...
								name="customerName" class="form-control" id="customer_name"
