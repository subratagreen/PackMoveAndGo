...
<meta name="viewport" content="width=device-width,initial-scale=1">
 <meta name="description" content="Transportation Services of  Movers and Packers – Delhi NCR is provided as per the client's specifications and requirements. These services are well manned by an expert team keeping in mind the time accuracy" />
    <meta name="keywords" content="Transportation Services Ved vihar | Packing and Moving Services in Secunderabad " />
			...
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 pull-right maintxt">
				...
				<div class="col-md-12  wow fadeInDown" data-wow-delay="0.4s">
					<div class="row">
						...
						<h3 class="colorred">Transportation Services</h3>
						<div class="col-md-6 col-sm-6 col-xs-12 pull-right mrbtm2">
							<img src="${pageContext.request.contextPath}/resources/images/transportation-services.jpg" width="450"
								height="300" alt="Transportation Services"
								class="img-responsive img-rounded img-thumbnail"
								data-toggle="tooltip" data-placement="left"
								title="Transportation Services" />
						</div>
						<p>Transportation Services&nbsp;of  Movers and Packers
							– Delhi NCR is provided as per the client's specifications and
							requirements. These services are well manned by an expert team
							keeping in mind the time accuracy. In the course of timeliness,
							Packers and Movers in Delhi NCR ( Packers Movers) does
							not compromise on the maintaining the safety precautions. The
							products that we procure, Movers and Packers in Delhi NCR
							( Movers Packers) tend to deliver them in the correct
							location in the date as per the specifications.</p>
